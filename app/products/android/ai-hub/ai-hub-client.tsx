                        ...
                        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
                            ...
                            >
                                ...
                                <p className="mb-8 text-lg text-muted leading-relaxed">
                                    A privacy-first AI chat app that puts you in
                                    control. Bring your own OpenRouter API key,
                                    access hundreds of AI models, and enjoy
                                    intelligent conversations with complete
                                    privacy. Your key, your models, your data.
                                </p>
                    ...
                    <div className="mx-auto max-w-6xl">
                        ...
                        >
                            ...
                            <p className="mx-auto max-w-2xl text-lg text-muted">
                                Everything you need for intelligent AI
                                conversations, designed with privacy and
                                flexibility in mind.
                            </p>
                        </motion.div>
                    ...
                    <div className="mx-auto max-w-6xl">
                        ...
                        >
                            ...
                            <p className="mx-auto mb-12 max-w-2xl text-lg text-muted">
                                We&apos;re working on expanding AI Hub&apos;s
                                capabilities beyond text. Soon you&apos;ll be
                                able to interact with AI using multiple input
                                types.
                            </p>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-muted">
                                                Watch AI responses appear word
                                                by word with seamless SSE
                                                streaming. No waiting for
                                                complete responses.
                                            </p>
                                        </div>
                                    </div>
                        ...
                        >
                            ...
                            <div className="relative z-10 text-center">
                                ...
                                <p className="mx-auto mb-8 max-w-xl text-lg text-muted">
                                    Download AI Hub today and experience the
                                    freedom of AI conversations on your terms.
                                    Free to download, pay only for your API
                                    usage.
                                </p>
                    ...
                    <div className="mx-auto max-w-4xl">
                        ...
                        >
                            ...
                            <p className="text-xs text-muted text-center max-w-md">
                                By downloading and using AI Hub, you agree to
        ...
        <section className="px-4 py-20 md:py-28 overflow-hidden bg-card/30">
            <div className="mx-auto max-w-6xl">
                ...
                >
                    ...
                    <p className="mx-auto max-w-2xl text-lg text-muted">
                        Take a tour through AI Hub&apos;s beautiful and
                        intuitive interface
                    </p>
                </motion.div>
