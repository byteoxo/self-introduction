                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted">
                                        AI Hub is designed with privacy at its
                                        core. We believe you should have
                                        complete control over your data. Your
                                        API keys are encrypted locally, your
                                        conversations stay on your device, and
                        ...
                        >
                            ...
                            <section className="mb-12 rounded-2xl border border-card-border bg-card/30 p-6 md:p-8">
                                <p className="text-muted leading-relaxed">
                                    ...
                                    (&quot;we,&quot; &quot;us,&quot; or
                                    &quot;our&quot;) collects, uses, and shares
                                    information when you use AI Hub (&quot;the
                                    App&quot;). We are committed to protecting
                            ...
                            >
                                ...
                                <ul className="list-disc pl-6 text-muted space-y-2 mb-4">
                                    <li>
                                        ...
                                        unique device identifiers (for crash
                                        reporting only)
                                    </li>
                                    <li>
                                        <strong>Usage Analytics:</strong> App
                                        feature usage, session duration, button
                                        interactions (anonymized)
                                    </li>
                                    <li>
                                        <strong>Crash Reports:</strong>{' '}
                                        Technical logs when the app encounters
                                        errors
                                    </li>
                                    <li>
                                        <strong>Performance Data:</strong> App
                                        load times, response times (aggregated)
                                    </li>
                                </ul>
                            ...
                            >
                                ...
                                <ul className="list-disc pl-6 text-muted space-y-2 mb-6">
                                    ...
                                    <li>
                                        Settings and preferences are stored
                                        locally
                                    </li>
                                    <li>
                                ...
                                <p className="text-muted mb-3">
                                    When you send a message, the following data
                                    is transmitted to OpenRouter and the
                                    selected LLM provider:
                                </p>
                                <ul className="list-disc pl-6 text-muted space-y-2 mb-6">
                                    <li>
                                        Your message content (to generate a
                                        response)
                                    </li>
                                ...
                                <div className="rounded-xl border border-yellow-500/30 bg-yellow-500/10 p-4">
                                    <p className="text-yellow-400 text-sm">
                                        <strong>⚠️ Important:</strong> Data
                                        transmitted to OpenRouter and LLM
                                        providers is subject to their respective
                                        privacy policies. We encourage you to
                                        review OpenRouter&apos;s privacy policy
                                        and the policies of the AI model
                                        providers you use.
                                    </p>
                                </div>
                            </Section>
                            ...
                            >
                                ...
                                <p className="text-muted">
                                    ...
                                    law, court order, or government request, or
                            ...
                            >
                                ...
                                <ul className="list-disc pl-6 text-muted space-y-2 mb-6">
                                    <li>
                                        <strong>Access:</strong> Know what data
                                        we collect and how it&apos;s used
                                    </li>
                                    <li>
                                        <strong>Deletion:</strong> Delete your
                                        local data by uninstalling the app
                                    </li>
                                    <li>
                                        <strong>Portability:</strong> Export
                                        your chat history (feature in
                                        development)
                                    </li>
                                    <li>
                                        <strong>Objection:</strong> Opt-out of
                                ...
                                <p className="text-muted mb-3">
                                    ...
                                    Regulation, EU residents have additional
                                    rights:
                                </p>
                                <ul className="list-disc pl-6 text-muted space-y-2 mb-6">
                                    <li>
                                    ...
                                    <li>
                                        Right to restrict processing in certain
                                        circumstances
                                    </li>
                                    <li>
                                ...
                                <p className="text-muted mb-4">
                                    ...
                                    We process data based on legitimate
                                    interests (app functionality) and your
                                    consent (analytics).
                                </p>
                                ...
                                <ul className="list-disc pl-6 text-muted space-y-2 mb-6">
                                    ...
                                    <li>
                                        Delete personal information held by
                                        businesses
                                    </li>
                                    <li>
                                ...
                                <p className="text-muted mb-4">
                                    <strong>Notice:</strong> We do not sell or
                                    share personal information as defined under
                                    CCPA/CPRA.
                                </p>
                                ...
                                <ul className="list-disc pl-6 text-muted space-y-2">
                                    <li>
                                        Know and decide about the processing of
                                        your personal information
                                    </li>
                                    <li>
                                        Restrict or refuse processing (except as
                                        required by law)
                                    </li>
                                    <li>
                                        Access and copy your personal
                                        information
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        Request deletion when processing
                                        purposes are achieved
                                    </li>
                                    <li>Withdraw consent at any time</li>
                                    <li>
                                        Request explanation of personal
                            ...
                            >
                                ...
                                <ul className="list-disc pl-6 text-muted space-y-2 mb-6">
                                    <li>
                                        <strong>Chat History:</strong> Retained
                                        until you delete conversations or
                                        uninstall the app
                                    </li>
                                    <li>
                                        <strong>API Key:</strong> Stored until
                                        you remove it or uninstall the app
                                    </li>
                                    <li>
                                        <strong>Settings:</strong> Retained
                                        until you reset them or uninstall the
                                        app
                                    </li>
                                </ul>
                                ...
                                <ul className="list-disc pl-6 text-muted space-y-2 mb-6">
                                    <li>
                                        <strong>Analytics:</strong> Aggregated
                                        for 24 months, then deleted
                                    </li>
                                    <li>
                                        <strong>Crash Logs:</strong> Retained
                                        for 90 days
                                    </li>
                                    <li>
                                        <strong>Support Tickets:</strong>{' '}
                                        Retained for 3 years for legal
                                        compliance
                                    </li>
                                </ul>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-muted text-sm">
                                                Swipe left on any chat in the
                                                History tab and tap delete
                                            </p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-muted text-sm">
                                                Uninstall the app to remove all
                            ...
                            >
                                ...
                                <p className="text-muted mb-4">
                                    AI Hub is not intended for children under
                                    the age of 13 (or equivalent minimum age in
                                    your jurisdiction). We do not knowingly
                                ...
                                <p className="text-muted mb-4">
                                    In compliance with the Children&apos;s
                                ...
                                <ul className="list-disc pl-6 text-muted space-y-2 mb-6">
                                    ...
                                    <li>
                                        Will delete any such information upon
                                        discovery
                                    </li>
                                    <li>
                                ...
                                <p className="text-muted">
                                    If you believe your child has provided us
                            ...
                            >
                                ...
                                <p className="text-muted mb-4">
                                    When you use AI Hub, your message data may
                                    be processed by OpenRouter and LLM providers
                                    in various countries, including the United
                                    States. These transfers are necessary to
                                    provide you with AI chat functionality.
                                </p>
                                ...
                                <p className="text-muted mb-3">
                                    For cross-border data transfers, we
                                    implement:
                                </p>
                                <ul className="list-disc pl-6 text-muted space-y-2 mb-6">
                                    <li>
                                    ...
                                    <li>
                                        Technical measures (encryption in
                                        transit and at rest)
                                    </li>
                                    <li>
                                        Regular security assessments of data
                                        handling practices
                                    </li>
                                </ul>
                                ...
                                <p className="text-muted mb-3">
                                    For users in China, in compliance with the
                                    Cybersecurity Law and Data Security Law:
                                </p>
                                <ul className="list-disc pl-6 text-muted space-y-2">
                                    <li>
                                        We disclose that your message data is
                                        processed outside China through
                                        OpenRouter
                                    </li>
                                    <li>
                                        By using the app, you consent to this
                                        cross-border data transfer
                                    </li>
                                    <li>
                                        We implement security measures in
                                        accordance with Chinese cybersecurity
                                        standards
                                    </li>
                                    <li>
                                        No &quot;important data&quot; as defined
                                        by Chinese law is collected or exported
                                    </li>
                                </ul>
                            </Section>
                            ...
                            >
                                ...
                                <ul className="list-disc pl-6 text-muted space-y-2 mb-6">
                                    ...
                                    <li>
                                        TLS 1.3 encryption for all data in
                                        transit
                                    </li>
                                    <li>
                                        No plain-text storage of sensitive
                                        information
                                    </li>
                                    <li>
                                ...
                                <ul className="list-disc pl-6 text-muted space-y-2">
                                    <li>
                                        Enabling device screen lock and
                                        biometric authentication
                                    </li>
                                    <li>
                                        Keeping your device&apos;s operating
                                        system updated
                                    </li>
                                    <li>
                                        Not sharing your device with untrusted
                                        individuals
                                    </li>
                                    <li>
                                        Regularly updating AI Hub to the latest
                                        version
                                    </li>
                                </ul>
                            </Section>
                            ...
                            >
                                ...
                                <ul className="list-disc pl-6 text-muted space-y-2 mb-4">
                                    ...
                                    <li>
                                        Your continued use of AI Hub after
                                ...
                                <p className="text-muted">
                                    Previous versions of this Privacy Policy are
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted mb-4">
                                            ...
                                            Privacy Policy or want to exercise
                                            your privacy rights:
                                        </p>
                                        ...
                                        <p className="text-muted mt-4 text-sm">
                                            ...
                                            privacy-related inquiries within 30
                                            days.
                                        </p>
                                    </div>
                                </div>
