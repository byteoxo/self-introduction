                        ...
                        >
                            ...
                            >
                                ...
                                <ul className="list-disc pl-6 text-muted space-y-2 mb-4">
                                    <li>
                                        Recursive folder scanning for media file
                                        discovery
                                    </li>
                                    <li>
                                        Batch compression of images, videos, and
                                        audio files
                                    </li>
                                    <li>
                                        Configurable quality presets (Low,
                                        Medium, High)
                                    </li>
                                    <li>Multiple output format support</li>
                                    <li>
                                        ZIP archive output with preserved
                                        directory structure
                                    </li>
                                    <li>
                                        Hardware-accelerated encoding on Apple
                                        Silicon
                                    </li>
                                </ul>
                                ...
                                <p className="text-muted">
                                    All compression operations are performed
                                    locally on your Mac. Your files are never
                                    uploaded to any server. This ensures
                                    complete privacy and allows the App to
                            ...
                            >
                                ...
                                <ul className="list-disc pl-6 text-muted space-y-2 mb-4">
                                    ...
                                    <li>
                                        Sublicense, rent, or lease the App to
                                        third parties
                                    </li>
                                    <li>
                                        Use the App in any way that could damage
                            ...
                            >
                                ...
                                <ul className="list-disc pl-6 text-muted space-y-2 mb-4">
                                    <li>
                                        Compressing personal photos and videos
                                        to save storage space
                                    </li>
                                    <li>
                                        Preparing media files for web upload or
                                        sharing
                                    </li>
                                    <li>
                                        Converting media formats for
                                        compatibility
                                    </li>
                                ...
                                <ul className="list-disc pl-6 text-muted space-y-2 mb-4">
                                    <li>
                                        Process files you do not have rights to
                                        modify
                                    </li>
                                    <li>
                                        Circumvent copy protection or DRM
                                        mechanisms
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        Process classified or restricted
                                        government materials without
                                        authorization
                                    </li>
                                </ul>
                                ...
                                <p className="text-muted">
                                    You are solely responsible for ensuring you
                                    have the necessary rights and permissions to
                                    compress any media files using the App. We
                                    are not responsible for any unauthorized use
                                    of copyrighted or protected content.
                                </p>
                            </Section>
                            ...
                            >
                                ...
                                <p className="text-muted mb-4">
                                    ...
                                    laws. All rights not expressly granted in
                                ...
                                <p className="text-muted mb-4">
                                    You retain all ownership rights to your
                                    original media files and any compressed
                                    versions created using the App. We do not
                                ...
                                <p className="text-muted">
                                    ...
                                    suggestions, or bug reports, you grant us a
                                    perpetual, royalty-free license to use such
                                    feedback to improve the App without any
                                    obligation to you.
                                </p>
                            </Section>
                            ...
                            >
                                ...
                                <ul className="list-disc pl-6 text-muted space-y-2 mb-4">
                                    <li>
                                        The App will meet your specific
                                        requirements
                                    </li>
                                    <li>
                                        The App will be uninterrupted, timely,
                                        secure, or error-free
                                    </li>
                                    <li>
                                        Compression results will achieve any
                                        particular file size reduction
                                    </li>
                                    <li>
                                        Output quality will match your
                                        expectations
                                    </li>
                            ...
                            >
                                ...
                                <p className="text-muted mb-4">
                                    ...
                                    failures, or system crashes could
                                ...
                                <p className="text-muted mb-4">
                                    Always verify compressed output files before
                                    deleting originals. Check that the quality
                                    meets your standards and that all files were
                                    processed correctly.
                                </p>
                                ...
                                <p className="text-muted">
                                    ...
                                    both the original files and compressed
                                    output during the compression process. The
                                    App requires temporary storage space while
                                    processing files.
                                </p>
                            </Section>
                            ...
                            >
                                ...
                                <p className="text-muted mb-4">
                                    Any disputes arising from these Terms shall
                                    first be attempted to be resolved through
                                    informal negotiation. If informal resolution
                                    fails, disputes shall be resolved through
                                    binding arbitration.
                                </p>
                            ...
                            >
                                ...
                                <p className="text-muted">
                                    ...
                                    uninstalling the App. We may terminate or
                                    suspend your access if you violate these
                                    Terms.
                                </p>
                            </Section>
