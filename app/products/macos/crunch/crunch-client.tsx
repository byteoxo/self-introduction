...
const features = [
  {
    ...
    highlights: ["Recursive Scanning", "Batch Selection", "Smart Filtering"],
  },
  {
    icon: Settings2,
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              ...
              >
                ...
                <p className="mb-8 text-lg text-muted leading-relaxed">
                  Compress images, videos, and audio files with just a few
                  clicks. Apple Silicon optimized, completely local, and
                  blazingly fast. Shrink your media library without sacrificing
                  quality.
                </p>
              ...
              >
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium">Apple Silicon</span>
                  </div>
                </motion.div>
                <motion.div
          ...
          <div className="mx-auto max-w-6xl">
            ...
            >
              <h2 className="text-2xl font-bold mb-4">
                <span className="text-gradient">Supported Formats</span>
              </h2>
              <p className="text-muted">
                Compress all your media types with optimized codecs
              </p>
            </motion.div>
          ...
          <div className="mx-auto max-w-6xl">
            ...
            >
              ...
              <p className="mx-auto max-w-2xl text-lg text-muted">
                Everything you need for efficient media compression, designed
                for power users and casual users alike.
              </p>
            </motion.div>
        ...
        <section className="px-4 py-20 md:py-28 bg-card/30">
          <div className="mx-auto max-w-6xl">
            ...
            >
              ...
              <p className="mx-auto max-w-2xl text-lg text-muted">
                Three simple steps to compress your entire media library
              </p>
            </motion.div>
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              ...
              >
                <h2 className="mb-6 text-3xl font-bold md:text-4xl">
                  Why <span className="text-gradient">Crunch</span>?
                </h2>
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted">
                        Built specifically for M1/M2/M3 chips. Hardware
                        accelerated video encoding for maximum performance.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="mb-1 font-semibold">Complete Privacy</h3>
                      <p className="text-muted">
                        Your files never leave your Mac. No cloud processing, no
                        uploads, no tracking. 100% local.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="mb-1 font-semibold">Organized Output</h3>
                      <p className="text-muted">
                        Get your compressed files in a neat ZIP archive with
            ...
            >
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="mx-auto mb-8 max-w-xl text-lg text-muted">
                  Download Crunch today and reclaim your disk space. Compress
                  images, videos, and audio without compromising quality.
                </p>
          ...
          <div className="mx-auto max-w-4xl">
            ...
            >
              ...
              <p className="text-xs text-muted text-center max-w-md">
                By downloading and using Crunch, you agree to our Terms of
  ...
  return (
    <div className="flex h-full flex-col text-xs">
          ...
          <tbody>
            {files.map((file, i) => (
              ...
              >
                ...
                <td className="px-3 py-2 text-muted">{file.path}</td>
      ...
      <div className="flex items-center justify-between border-t border-card-border px-4 py-2">
        <div className="flex gap-2">
          <button type="button" className="rounded bg-card-border/50 px-2 py-1">
            All
          </button>
          <button type="button" className="rounded px-2 py-1 text-muted">
            Images
          </button>
          <button type="button" className="rounded px-2 py-1 text-muted">
            Video
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-muted flex items-center gap-2">
                <Image className="h-3 w-3 text-pink-400" /> Images
              </span>
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="rounded bg-card-border/50 px-2 py-0.5">MP4</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-muted flex items-center gap-2">
                <Music className="h-3 w-3 text-green-400" /> Audio
              </span>
              <span className="rounded bg-card-border/50 px-2 py-0.5">MP3</span>
            </div>
          </div>
        </div>
    ...
    <div className="flex h-full flex-col text-xs">
      ...
      <div className="flex-1 p-4 space-y-4">
        ...
        <div className="rounded-lg border border-card-border bg-card/50 p-4">
          ...
          <p className="text-muted mb-3 truncate">birthday_video.mp4</p>
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="rounded-lg border border-card-border bg-card/50 p-3 text-center">
            <p className="text-lg font-bold text-blue-400">128 MB</p>
            <p className="text-muted">Original</p>
          </div>
          <div className="rounded-lg border border-card-border bg-card/50 p-3 text-center">
            <p className="text-lg font-bold text-green-400">32 MB</p>
  ...
  return (
    <div className="flex h-full flex-col text-xs">
      ...
      <div className="border-b border-card-border px-4 py-3 flex items-center gap-2">
        ...
        <h3 className="font-semibold text-green-400">Compression Complete!</h3>
      </div>
      ...
      <div className="flex-1 overflow-auto p-4 space-y-4">
        ...
        <div className="grid grid-cols-3 gap-2">
          ...
          <div className="rounded-lg border border-card-border bg-card/50 p-3 text-center">
            <p className="text-lg font-bold text-green-400">33.1 MB</p>
        ...
        <div className="rounded-lg border border-card-border bg-card/50 overflow-hidden">
          <table className="w-full">
            ...
            <tbody>
              {results.map((file) => (
                <tr key={file.name} className="border-b border-card-border/50">
                  <td className="px-3 py-2 truncate max-w-[120px]">
                    {file.name}
                  </td>
                  <td className="px-3 py-2 text-muted">{file.original}</td>
                  <td className="px-3 py-2 text-green-400">
                    {file.compressed}
                  </td>
                  <td className="px-3 py-2 text-blue-400">{file.ratio}</td>
                </tr>
              ))}
            </tbody>
          </table>
    ...
    <section className="px-4 py-20 md:py-28 overflow-hidden">
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="mx-auto max-w-2xl text-lg text-muted">
            See Crunch&apos;s clean and intuitive interface in action
          </p>
        </motion.div>
          ...
          <div className="flex items-center justify-center gap-8">
            ...
            <div className="relative flex items-center justify-center">
              <AnimatePresence mode="wait">
                ...
                >
                  <DesktopMockup screen={appScreenshots[activeIndex].screen} />
