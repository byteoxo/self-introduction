...
const featuredProducts = [
    ...
    },
    {
        ...
        description:
            'Process entire directories with one command. Open source.',
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <p className="mx-auto max-w-md text-lg text-muted">
                                    Looks like this page decided to explore the
                                    digital void. Don&apos;t worry, we&apos;ll
                        ...
                        >
                            ...
                            <div className="grid gap-6 md:grid-cols-3">
                                {featuredProducts.map((product, index) => {
                                    ...
                                    const LinkComponent = product.external
                                        ? 'a'
                                        : Link
                        ...
                        >
                            <motion.p
                                ...
                                transition={{ delay: 2 }}
                            >
                                🎯 Pro tip: The best adventures start with a
                                wrong turn
                            </motion.p>
                        </motion.section>
                    </motion.div>
