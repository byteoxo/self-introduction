          ...
          <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
            ...
            <motion.div variants={itemVariants} className="lg:col-span-1">
              ...
              <p className="mb-6 text-sm leading-relaxed text-muted">
                ...
                software development and AI Technology. Building AI-powered apps
                and blazingly fast tools.
              </p>
          ...
          >
            <div className="flex flex-col items-center gap-4 md:flex-row md:justify-between">
              <div className="text-center md:text-left">
                <h4 className="mb-1 font-semibold">Built with modern tech</h4>
                <p className="text-sm text-muted">
                  This portfolio is open source and built with the latest tools
                </p>
              </div>
